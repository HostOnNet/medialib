...
<script language="JavaScript" type="text/javascript" src="/js/watch-html5.js"></script>
...
<div id="watch_col_player">
        <video id="video-player" controls="" width="720" height="406">
            <source src="http://localhost:8080/vid/{{ $media->file_name }}" type="video/mp4">
        </video>
...
<script>
    jQuery(function () {
        ...
        player.currentTime = {{  $time_start_ms }} / 1000;
